...
export default async function DashboardPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 md:px-6 py-10 md:py-16 space-y-16 md:space-y-20">

      {/* Hero (centered): brand, total roles, chart, toggles, constituents */}
      <HeroChart series={series} />

      {/* Top Roles — inline search filters in place */}
      <section id="roles" className="space-y-5 scroll-mt-20">
        ...
        <TopRoles roles={roles.slice(0, 24)} showSearch />
      </section>

      {/* Top Companies — inline search filters in place */}
      <section id="companies" className="space-y-5 scroll-mt-20">
        ...
        <div className="bg-surface border border-surface-border rounded-2xl p-4 md:p-6">
          <CompanyTable companies={companies} showSearch />
        </div>
      </section>
